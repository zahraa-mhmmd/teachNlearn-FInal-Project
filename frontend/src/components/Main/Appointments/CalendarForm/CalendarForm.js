...
const CalendarForm = ({
  ...
  const displaySessionTime = () => {
    if (studentFormState.startTime) {
      const sessionStart = moment(studentFormState.startTime).format(
        'dddd Do MMM h:mm'
      );
      const sessionEnd = moment(studentFormState.endTime).format('h:mm a');
        ...
        <div className="form-wrapper">
          ...
          >
            ...
            >
              ...
              <div>
                {/* <AuthSelect
                  value={studentFormState.teacher}
                  placeholder="Teacher"
                  type="text"
                  icon="userPlus"
                  directive="teacher"
                ...
                <div className="react-datepicker-master-wrapper">
                  ...
                  <DatePicker
                    ...
                    showTimeSelect
                    selected={studentFormState.startTime}
                    minDate={moment().toDate()}
                    maxDate={moment().add(1, 'year').toDate()}
                    minTime={
                      !_.isEmpty(selectedTeacher) &&
                      moment(
                        selectedTeacher.teacherInfo.availability.openingTime
                      ).toDate()
                    }
                    maxTime={
                      !_.isEmpty(selectedTeacher) &&
                      moment(
                        selectedTeacher.teacherInfo.availability.closingTime
                      ).toDate()
                    }
                    onChange={date => {
                      setStudentFormState({
                        ...
                        startTime: date,
                        endTime: moment(date)
                          .add(studentFormState.sessionDuration, 'minutes')
                          .toDate(),
                      });
                      setFlashMessage(null);
                    }}
                  ...
                  <div className="time-slot">
                    <div>
                      <input
                        ...
                        name="duration"
                        id=""
                        checked={studentFormState.sessionDuration === '30'}
                        value="30"
                    ...
                    <span className="appointment-time">
                      {studentFormState.sessionDuration === '30'
                        ? displaySessionTime()
                        : ''}
                    </span>
                  </div>
                  <div className="time-slot">
                    <div>
                      <input
                        ...
                        name="duration"
                        id=""
                        checked={studentFormState.sessionDuration === '60'}
                        value="60"
                    ...
                    <span className="appointment-time">
                      {studentFormState.sessionDuration === '60'
                        ? displaySessionTime()
                        : ''}
                    </span>
                  </div>
  ...
  const showForm = () => {
    return user.isTeacher ? TeacherForm() : StudentForm();
  };
  return showForm();
};
